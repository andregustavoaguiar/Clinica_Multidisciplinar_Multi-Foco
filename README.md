...
No terminal psql: <br>
Copie e cole tabela a tabela, os comandos SQL fornecidos no psql: <a href="https://github.com/andregustavoaguiar/Clinica_Multidisciplinar_Multi-Foco/blob/main/modelagem_fisica%20-%20projeto_clinicaMultidisciplinar.sql">Script de Criação do Banco</a>
...
<ul>
  ...
  <li>Passo 3: Copie e cole os comandos SQL fornecidos para criação das tabelas:  <a href="https://github.com/andregustavoaguiar/Clinica_Multidisciplinar_Multi-Foco/blob/main/modelagem_fisica%20-%20projeto_clinicaMultidisciplinar.sql">Script de Criação do Banco</a><br> e execute o script ▶️.</li>
</ul>
...
Este projeto está licenciado sob os termos da Licença Customizada (MIT-style). Consulte o arquivo <a href="https://github.com/andregustavoaguiar/Clinica_Multidisciplinar_Multi-Foco/blob/main/license.txt">LICENSE.txt</a> para obter mais detalhes sobre as condições de uso e distribuição.
